...
// <script>
//   const scene1Data = {
//     picture: "https://cdn-icons-png.flaticon.com/512/5226/5226126.png",
//     depth: 44,
//     backwards: false,
//     animation: false,
//     wireframe: true,
...
//   };
//   const scene2Data = {
//     picture: "https://cdn-icons-png.flaticon.com/512/5226/5226384.png",
//     depth: 44,
//     backwards: false,
//     animation: false,
//     wireframe: true,
...
function createScene(canvasId, userData) {
  ...
  function getClosestPrecision(imageWidth, imageHeight) {
    ...
    const divisors = [];
    for (
      let i = userData.resolution;
      i <= Math.min(imageWidth, imageHeight);
      i++
    ) {
...
createScene("scene1", scene1Data);
createScene("scene2", scene2Data);
createScene("scene3", scene3Data);
createScene("scene4", scene4Data);
createScene("scene5", scene5Data);
createScene("scene6", scene6Data);
