...
function Values() {
  this.picture = "https://play-lh.googleusercontent.com/pYXciEtsSzizg_u5BFdNl8GWl1K-5Rjp8X8ltWDE0LXq4NKG-riznMOsfnlYu1sNJw=s256-rw";
  // only use multiples 2,4,6,8
  this.precision = 4;
  this.depth = 33;
...
function createParticles(randomize) {
  ...
  for (var y = 0; y < bill.height; y += userData.precision) {
    for (var x = 0; x < bill.width; x += userData.precision) {
      ...
      var outColor = new THREE.Color().set(
